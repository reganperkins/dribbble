<template>
  <section :class="['sign-up', classProp]">
    <span class="sign-in"
      >Already a member? <a href="#" class="link">Sign In</a></span
    >
    <main>
      <a herf="https://dribbble.com" class="dribbble-logo">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 24" role="img">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <form v-on:submit.prevent="signUp">
        ...
        <div class="form-group">
          <fieldset>
            ...
            <input
              ...
              v-model="name"
              id="fullname"
              :class="{'invalid': attemptSubmit && missingName}"
              type="text"
            />
          </fieldset>
          ...
          <fieldset>
            ...
            <input
              ...
              v-model="username"
              id="username"
              :class="{'invalid': attemptSubmit && missingUsername}"
              type="text"
            />
          </fieldset>
        </div>
        ...
        <div class="form-group">
          <fieldset>
            ...
            <input name="email" v-model="email" id="email" type="email" :class="{'invalid': attemptSubmit && missingEmail}"/>
          </fieldset>
        </div>
        ...
        <div class="form-group">
          <fieldset>
            ...
            <input
              ...
              :class="{'invalid': attemptSubmit && (missingPassword || invalidPassword)}"
            />
          </fieldset>
        </div>
          ...
          <fieldset>
            <div class="checkbox-wrapper">
              <input
                ...
                :class="{'invalid': attemptSubmit && missingTerms}"
              />
...
export default {
  ...
  methods: {
    formIsValid() {
      // this.errors = [];
      // const { name, username, email, password, acceptedTerms } = this;

      // if (!acceptedTerms) {
      //   this.errors.push("You must accept the terms.");
      // }

      // Object.entries({ name, username, email, password }).forEach(([field, value]) => {
      //   if (!value) this.errors.push(`${field} required.`);
      // });
